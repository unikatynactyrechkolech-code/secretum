  ...
  return (
    <section id="uvod" className="relative flex flex-1 items-center overflow-hidden bg-black">
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-2 px-5 py-3 sm:px-6 lg:grid-cols-2 lg:gap-8 lg:px-10 lg:py-0">
        <div>
          <p className="mb-1 text-[9px] font-semibold tracking-[0.25em] text-accent sm:text-xs lg:mb-3 lg:text-sm">
            DETEKTIVNÍ KANCELÁŘ
          </p>
          <h1 className="font-heading text-lg leading-tight tracking-wide text-white sm:text-2xl lg:text-4xl xl:text-5xl">
            PRAVDA UKRYTÁ
            <br />
            <span className="text-accent">V DETAILECH</span>
          </h1>

          <p className="mt-1.5 max-w-xl text-[11px] leading-snug text-white/80 sm:text-sm lg:mt-4 lg:text-base">
          ...
          <p className="mt-1.5 font-heading text-xs tracking-wide text-white/90 sm:text-base lg:mt-4 lg:text-lg">
            DŮKAZY, NA KTERÉ SE MŮŽETE SPOLEHNOUT.
          </p>

          <div className="mt-2.5 flex flex-col gap-1.5 sm:flex-row lg:mt-6 lg:gap-3">
            <a
              href="#kontakt"
              className="flex items-center justify-center gap-2 rounded-md bg-accent px-4 py-1.5 text-[11px] font-semibold tracking-wide text-white transition-colors hover:bg-red-700 sm:text-sm lg:px-7 lg:py-3.5"
            >
            ...
            <a
              href="#sluzby"
              className="flex items-center justify-center gap-2 rounded-md border border-white/30 px-4 py-1.5 text-[11px] font-semibold tracking-wide text-white transition-colors hover:border-accent hover:text-accent sm:text-sm lg:px-7 lg:py-3.5"
            >
